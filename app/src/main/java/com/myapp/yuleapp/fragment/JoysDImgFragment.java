 ...
 * 描述:
 **/
public class JoysDImgFragment extends BaseFragment {
    ...
    private void getData() {
        ...
        Request<String> request = NoHttp.createStringRequest(ConstantsUtil.URL_JOYS_DIMG + ConstantsUtil.URL_COMMON, RequestMethod.GET);
        ...
        requestQueue.add(ConstantsUtil.WHAT_JOY_DIMG, request, new OnResponseListener<String>() {
            @Override
